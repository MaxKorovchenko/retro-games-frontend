  ...
  return (
    <article className={styles.container}>
      ...
      <section>
        ...
        <h3 className={styles.subtitle}>Genesis of the Sega Genesis</h3>
      ...
      <section>
        ...
        <h3 className={styles.subtitle}>Official Variants</h3>
        <ul className={styles.list}>
          <li className={styles.listItem}>
        ...
        <h3 className={styles.subtitle}>Add-ons</h3>
        <ul className={styles.list}>
          <li className={styles.listItem}>
      ...
      <section>
        ...
        <h3 className={styles.subtitle}>Transition to 32-bit Consoles</h3>
        <p className={styles.text}>
