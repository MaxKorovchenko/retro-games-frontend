  ...
  return (
    <article className={styles.container}>
      ...
      <section>
        ...
        <h3 className={styles.subsubtitle}>The Dawn of 8-bit Consoles</h3>
      ...
      <section>
        ...
        <h3 className={styles.subsubtitle}>Famicom Variants</h3>
        <ul className={styles.list}>
          <li className={styles.listItem}>
        ...
        <h3 className={styles.subsubtitle}>NES Variants</h3>
        <ul className={styles.list}>
          <li className={styles.listItem}>
      ...
      <section>
        ...
        <h3 className={styles.subsubtitle}>Transition to 16-bit Consoles</h3>
        <p className={styles.text}>
